...
int main(void) {
    ...
    for (int i = 0; i < 5; i++) {
        ...
        printf("|%-10lf", Time_d[i]);
        printf("|%-20lld", Compare_d[i]);
        printf("|%-20lld", Swap_d[i]);
...
void Heap_Sort_Func(element arr[]) {
    ...
    for (int i = 0; i < N; i++) {
        ...
        for (int j = i_n_i; j / 2 > 0; j /= 2) {
            ...
            if (strcmp(heap[j].str, heap[j / 2].str) < 0 || 
                (strcmp(heap[j].str, heap[j / 2].str) == 0 && heap[j].i_n_i < heap[j / 2].i_n_i)){
    ...
    for (int i = 0; i < N; i++) {
        ...
        while (j * 2 < i_n_i) {
            ...
            if (child + 1 < i_n_i && (strcmp(heap[child + 1].str, heap[child].str) < 0 || 
                                   (strcmp(heap[child + 1].str, heap[child].str) == 0 && heap[child + 1].i_n_i < heap[child].i_n_i))) {
                child++;
            }

            
            if (strcmp(heap[j].str, heap[child].str) > 0 ||
               (strcmp(heap[j].str, heap[child].str) == 0 && heap[j].i_n_i > heap[child].i_n_i)) {
...
void Quick_Sort_Func(element arr[], int l, int r) {
    ...
    while (lower < upper) {
        ...
        while ((lower <= r) && (strcmp(arr[lower].str, arr[l].str) < 0 || 
                               (strcmp(arr[lower].str, arr[l].str) == 0 && arr[lower].i_n_i < arr[l].i_n_i))) {
            Compare_d[2]++;
            lower++;
        }
        upper--;
        ...
        while ((upper >= l + 1) && (strcmp(arr[upper].str, arr[l].str) > 0 || 
                               (strcmp(arr[upper].str, arr[l].str) == 0 && arr[upper].i_n_i >= arr[l].i_n_i))) {
            Compare_d[2]++;
            upper--;
        }
        if (lower < upper) {
...
int check_stable(element arr[])
{
    for (int i = 0; i < N-1; i++) {
        if (strcmp(arr[i].str, arr[i + 1].str) == 0) {
            if (arr[i].i_n_i > arr[i + 1].i_n_i)return 0;
        }
    }
    return 1;
}
